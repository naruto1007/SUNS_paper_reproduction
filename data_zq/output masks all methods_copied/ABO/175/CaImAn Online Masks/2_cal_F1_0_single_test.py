...
# Mask_sparse
dir_Masks_output = "D:\PyCharm_project\SUNS_paper_reproduction\data_zq\output masks all methods_copied\ABO\\175\CaImAn Online Masks"
filename_output = os.path.join(dir_Masks_output, "501271265_neurons_sparse.mat")
