...
# Mask_sparse
dir_Masks_output = "D:\PyCharm_project\SUNS_paper_reproduction\data_zq\output masks all methods_copied\ABO\STNeuroNet FinalMasks"
filename_output = os.path.join(dir_Masks_output, "FinalSegments_501484643_sparse.mat")
