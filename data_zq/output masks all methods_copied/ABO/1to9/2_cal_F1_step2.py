...
file_names = ['SUNS noSF output_masks 1to9', 'STNeuroNet FinalMasks 1to9', 'CaImAn Batch Masks 1to9', 'Suite2p Masks 1to9']
...
ax.set_title('ABO train 1 test 9', fontsize=fontsize)
