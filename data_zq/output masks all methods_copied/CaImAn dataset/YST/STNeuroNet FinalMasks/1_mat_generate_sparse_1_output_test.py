...
dir_Masks_output = "D:\PyCharm_project\SUNS_paper_reproduction\data_zq\output masks all methods_copied\CaImAn dataset\YST\STNeuroNet FinalMasks"
filename_output = os.path.join(dir_Masks_output, "FinalSegments_YST_part11_sparse.mat")
