...
def Performance_Cal_Suns_noSF(root_dir, result_dir, data_type_1, data_type_2, list_Exp_ID):
    ...
    dir_Masks_output = os.path.join(root_dir, result_dir, data_type_1, data_type_2, "SUNS noSF output_masks")
    dir_OutputMasks = os.path.join(dir_Masks_output, 'Output_Masks_')
...
Performance_Cal_Suns_noSF(root_dir, result_dir, data_type_1, data_type_2, list_Exp_ID)
