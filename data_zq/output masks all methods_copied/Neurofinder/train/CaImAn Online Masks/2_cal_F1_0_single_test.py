...
filename_GT = os.path.join(dir_Masks_GT, "FinalMasks_04.00_sparse_generated.mat")

data_GT = loadmat(filename_GT)
GTMasks_2 = data_GT['GTMasks_2'].transpose()

# Mask_sparse
dir_Masks_output = "D:\PyCharm_project\SUNS_paper_reproduction\data_zq\output masks all methods_copied\\Neurofinder\\train\suite2p Masks"
filename_output = os.path.join(dir_Masks_output, "04.00_neurons_sparse.mat")
