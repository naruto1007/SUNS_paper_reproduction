...
filename_GT = os.path.join(dir_Masks_GT, "FinalMasks_02.00_sparse_generated.mat")
...
filename_output = os.path.join(dir_Masks_output, "FinalSegments_02.00_sparse.mat")
