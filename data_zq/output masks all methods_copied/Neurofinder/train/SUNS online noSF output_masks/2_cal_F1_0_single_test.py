...
filename_GT = os.path.join(dir_Masks_GT, "FinalMasks_02.00_sparse_generated_test_suns_online.mat")
...
filename_output = os.path.join(dir_Masks_output, "Output_Masks_02.00_sparse.mat")
